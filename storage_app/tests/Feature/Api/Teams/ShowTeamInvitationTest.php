...
class ShowTeamInvitationTest extends TestCase
{
     ...
     * @return void
     */
    public function test_showTeamInvitationTest()
    {
        ...
        $this->actingAs($user)->get('api/v1/teams/invitations/' . $teamFolder['data']['teamInvitations'][0]['uuid'])
                ->assertStatus(200);
