...
class ShowSharedItemTest extends TestCase
{
     ...
     * @return void
     */
    public function test_showSharedItemTest()
    {
        ...
        $response = $this->get('api/v1/share/' . $sharedItem['data']['items'][0]['data']['attributes']['token']);
