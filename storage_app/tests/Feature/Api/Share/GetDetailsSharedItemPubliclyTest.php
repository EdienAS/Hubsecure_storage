...
class GetDetailsSharedItemPubliclyTest extends TestCase
{
    use RefreshDatabase, WithFaker, UserSettingsTestData, FolderTestData;
    /**
     * GetDetailsSharedItemPubliclyTest.
     *
     * @return void
     */
    public function test_getDetailsSharedItemPubliclyTest()
    {
        ...
        $this->withUnencryptedCookies($cookie)
                ->get('api/v1/sharing/' . $sharedItem['data']['items'][0]['data']['attributes']['token'])
                ->assertStatus(200);
    }
}
