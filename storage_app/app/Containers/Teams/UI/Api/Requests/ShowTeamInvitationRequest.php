...
/**
 * Class ShowTeamInvitationRequest.
 *
 */
class ShowTeamInvitationRequest extends FormRequest
{
    ...
    {
        abort_if(Gate::denies('user_team_invitation_show'), Response::HTTP_FORBIDDEN, '403 Forbidden'); 
