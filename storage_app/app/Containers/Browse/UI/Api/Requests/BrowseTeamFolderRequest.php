...
/**
 * Class BrowseTeamFolderRequest.
 *
 */
class BrowseTeamFolderRequest extends FormRequest
{
    ...
    {
        abort_if(Gate::denies('user_team_folder_browse'), Response::HTTP_FORBIDDEN, '403 Forbidden'); 
